...
// Define an interface `ErrorContainer` using index properties
interface ErrorContainer {
  [prop: string]: string; // Index signature `[prop: string]: string` defines that any property with string key will have string value
}

// Create an instance `errorBag` of type `ErrorContainer`
const errorBag: ErrorContainer = {
  email: 'Not a valid email!', // Example of using index property
  username: 'Must start with a capital character!' // Example of using index property
};
